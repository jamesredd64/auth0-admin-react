      ...
      onUpdate({
        profile: {
          marketingBudget: {
            ...
            adBudget: Number(formData.marketingBudget.adBudget),
            costPerAcquisition: Number(formData.marketingBudget.costPerAcquisition),
            dailySpendingLimit: Number(formData.marketingBudget.dailySpendingLimit),
            marketingChannels: formData.marketingBudget.marketingChannels,
            monthlyBudget: Number(formData.marketingBudget.monthlyBudget),
            preferredPlatforms: formData.marketingBudget.preferredPlatforms,
            notificationPreferences: formData.marketingBudget.notificationPreferences,
            roiTarget: Number(formData.marketingBudget.roiTarget)
          }
        }
      });
      closeModal();
