    ...
    <>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-800/50 lg:p-6">
          ...
          onUpdate={(newInfo: Partial<UserMetadata>) => {
            handleUpdate({
              profile: {
                ...
                dateOfBirth: newInfo.dateOfBirth ? new Date(newInfo.dateOfBirth) : undefined,
        ...
        <UserMarketingCard 
          ...
          initialData={{
            marketingBudget: {
              amount: userData.profile.marketingBudget.amount,
              frequency: userData.profile.marketingBudget.frequency,
              adCosts: userData.profile.marketingBudget.adCosts
            }
          }}
        />
        <UserInfoCard 
